...
public record ExecutableParameterDto(long Id, long ExecutableVersionId, string Name, string TypeName, string? Description, bool Required, string? DefaultValue)
{
