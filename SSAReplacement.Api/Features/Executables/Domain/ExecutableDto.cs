...
public record ExecutableDto(long Id, string Name, DateTime CreatedAt, int ActiveVersion)
{
...
public record ExecutableDetailDto(long Id, string? Name, DateTime CreatedAt, IReadOnlyList<ExecutableVersionDto> Versions)
{
